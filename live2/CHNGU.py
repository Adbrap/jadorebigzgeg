...
start_15m = str(pd.Timestamp.today() + pd.DateOffset(-100))[0:10]
...
def Finder_IETE(time1,time_name1,start1,time2,time_name2,start2):
        while True:
                ...
                with my_lock:
                        ...
                        livePrice = df_livePrice['results'][4]
...
#
                ...
                print('--- Mode recherche CHNGU',time1,time_name1,' ---', flush=True)
                ...
                i = 0
                for i in range(local_max[-4] - 1, len(df)-1):
                    bleu.append(i)
                ...
                if (C - B) < (C - D) and (C - B) < (E - D) and (E - F) < (E - D) and (E - F) < (C - D) and B > D and F > D and B < C and F < E and A >= mirande2['c'].iloc[0] and verif == 0 and local_min[-1] > local_max[-1]:
                        ...
                        if accept == True:
                                ...
                                if I[1] > B and J[1] > F and moyenne_epaule1 <= moyenne_tete / 2 and moyenne_epaule2 <= moyenne_tete / 2 and moyenne_epaule1 >= moyenne_tete / 4 and moyenne_epaule2 >= moyenne_tete / 4 and df['h'].iloc[round(J[0])] > J[1] and accept == True:
...
th1 = threading.Thread(target=Finder_IETE, args=(1,minute,start_15m,30,minute,start_30m))
th2 = threading.Thread(target=Finder_IETE, args=(5,minute,start_15m,30,minute,start_30m))
th3 = threading.Thread(target=Finder_IETE, args=(15,minute,start_15m,1,heure,start_1h))
th4 = threading.Thread(target=Finder_IETE, args=(30,minute,start_30m,1,heure,start_1h))
th5 = threading.Thread(target=Finder_IETE, args=(1,heure,start_1h,6,heure,start_6h))
#th5 = threading.Thread(target=Finder_IETE, args=(4,heure,start_4h,1,jour,start_1d))
th6 = threading.Thread(target=Finder_IETE, args=(6,heure,start_6h,1,jour,start_1d))
th7 = threading.Thread(target=Finder_IETE, args=(1,jour,start_1d,3,jour,start_1d))
